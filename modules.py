...
# 对外接口，和原 resnet18 调用格式完全一致
def mobilenet_v2(weights=MobileNet_V2_Weights.IMAGENET1K_V1, **kwargs):
    return MobileNetV2Feature(weights=weights)
